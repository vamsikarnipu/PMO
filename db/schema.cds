...
type EmployeeBandEnum     : String enum {
    Band1 = 'Senior Vice President';        // ✅ FIXED: Made unique (was 'Vice President')
    Band2 = 'Vice President';                // ✅ FIXED: Now unique
...
entity Employee {
    key ohrId             : String;
        ...
        doj               : Date;           // ✅ FIXED: Changed from String to Date
        ...
        city              : String;
        lwd               : Date;          // ✅ FIXED: Changed from String to Date
