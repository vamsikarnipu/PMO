                ...
                sap.ui.require(["sap/ui/mdc/table/Column"], function (Column) {
                    ...
                    oAssocPromise.then(function(oAssocConfig) {
                        ...
                        if (sPropertyName === "oppId") {
                            console.log("[GenericDelegate] 🎯 OPP ID FIELD DETECTED! Association:", bIsAssoc, "Config:", oAssocConfig);
                        }
                        ...
                        if (bIsEnum) {
                            ...
                            // Create Input with Value Help button
