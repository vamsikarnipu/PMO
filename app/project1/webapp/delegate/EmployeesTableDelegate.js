        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "Employees": [
                        { name: "ohrId", path: "ohrId", label: "OHR ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "mailId", path: "mailId", label: "Email", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "firstName", path: "firstName", label: "First Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "lastName", path: "lastName", label: "Last Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "fullName", path: "fullName", label: "Full Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "employeeType", path: "employeeType", label: "Employee Type", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "doj", path: "doj", label: "Date of Joining", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true },
                        { name: "band", path: "band", label: "Band", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "role", path: "role", label: "Role", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "experience", path: "experience", label: "Experience", dataType: "Edm.Decimal", sortable: true, filterable: true, groupable: true },
                        { name: "phone", path: "phone", label: "Phone", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "isActive", path: "isActive", label: "Active", dataType: "Edm.Boolean", sortable: true, filterable: true, groupable: true }
                    ]
                };
