sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "Assignments";
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "Assignments": [
                        ...
                        { name: "employee_ohrId", path: "employee_ohrId", label: "Employee ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "project_projectId", path: "project_projectId", label: "Project ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "requirement_reqId", path: "requirement_reqId", label: "Requirement ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "supervisor_ohrId", path: "supervisor_ohrId", label: "Supervisor ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "state", path: "state", label: "State", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "plannedStartDate", path: "plannedStartDate", label: "Planned Start Date", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true },
                        { name: "plannedEndDate", path: "plannedEndDate", label: "Planned End Date", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true },
                        { name: "actualStartDate", path: "actualStartDate", label: "Actual Start Date", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true },
                        { name: "actualEndDate", path: "actualEndDate", label: "Actual End Date", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true }
                    ]
                };
    ...
    GenericTableDelegate.updateBindingInfo = function (oTable, oBindingInfo) {
        ...
        const sPath = oTable.getPayload()?.collectionPath || "Assignments";
