sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "Opportunities";
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                ...
                const mFallbackProperties = {
                    "Opportunities": [
                        { name: "oppId", path: "oppId", label: "Opportunity ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "sfdcOppId", path: "sfdcOppId", label: "SFDC Opportunity ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "name", path: "name", label: "Opportunity Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "stage", path: "stage", label: "Stage", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "probability", path: "probability", label: "Probability", dataType: "Edm.Int32", sortable: true, filterable: true, groupable: true },
                        ...
                        { name: "startDate", path: "startDate", label: "Start Date", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true },
                        { name: "endDate", path: "endDate", label: "End Date", dataType: "Edm.Date", sortable: true, filterable: true, groupable: true },
                        { name: "estimatedRevenue", path: "estimatedRevenue", label: "Estimated Revenue", dataType: "Edm.Decimal", sortable: true, filterable: true, groupable: true }
                    ]
                };
