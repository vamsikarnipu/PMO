        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                ...
                const mFallbackProperties = {
                    "Customers": [
                        { name: "customerId", path: "customerId", label: "Customer ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "custName", path: "custName", label: "Customer Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        ...
                        { name: "contactPerson", path: "contactPerson", label: "Contact Person", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
