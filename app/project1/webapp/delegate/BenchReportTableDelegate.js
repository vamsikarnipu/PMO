sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "EmployeeAllocation";
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "EmployeeAllocation": [
                        ...
                        { name: "email", path: "email", label: "Email", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        ...
                        { name: "experienceYears", path: "experienceYears", label: "Experience (Years)", dataType: "Edm.Decimal", sortable: true, filterable: true, groupable: true },
                        { name: "employeeStatus", path: "employeeStatus", label: "Status", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
    ...
    GenericTableDelegate.updateBindingInfo = function (oTable, oBindingInfo) {
        ...
        const sPath = oTable.getPayload()?.collectionPath || "EmployeeAllocation";
