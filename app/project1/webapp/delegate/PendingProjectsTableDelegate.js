            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "Projects": [
                        ...
                        { name: "tempProjectKey", path: "tempProjectKey", label: "Temp Project Key", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "officialPid", path: "officialPid", label: "Official PID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "name", path: "name", label: "Project Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
