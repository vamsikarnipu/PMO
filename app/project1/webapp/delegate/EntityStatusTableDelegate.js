sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "EntityStatuses";
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "EntityStatuses": [
                        { name: "statusId", path: "statusId", label: "Status ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "name", path: "name", label: "Status Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
    ...
    GenericTableDelegate.updateBindingInfo = function (oTable, oBindingInfo) {
        ...
        const sPath = oTable.getPayload()?.collectionPath || "EntityStatuses";
