sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "BusinessTypes";
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "BusinessTypes": [
                        { name: "businessTypeId", path: "businessTypeId", label: "Business Type ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "typeName", path: "typeName", label: "Type Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
    ...
    GenericTableDelegate.updateBindingInfo = function (oTable, oBindingInfo) {
        ...
        const sPath = oTable.getPayload()?.collectionPath || "BusinessTypes";
