sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "Skills";
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "Skills": [
                        { name: "skillId", path: "skillId", label: "Skill ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "skillName", path: "skillName", label: "Skill Name", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        { name: "category", path: "category", label: "Category", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
    ...
    GenericTableDelegate.updateBindingInfo = function (oTable, oBindingInfo) {
        ...
        const sPath = oTable.getPayload()?.collectionPath || "Skills";
