sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "ProjectTypes";
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "ProjectTypes": [
                        { name: "projectTypeId", path: "projectTypeId", label: "Project Type ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
    ...
    GenericTableDelegate.updateBindingInfo = function (oTable, oBindingInfo) {
        ...
        const sPath = oTable.getPayload()?.collectionPath || "ProjectTypes";
