sap.ui.define([
    ...
    GenericTableDelegate.fetchProperties = function (oTable) {
        ...
        const sCollectionPath = oTable.getPayload()?.collectionPath?.replace(/^\//, "") || "ProjectRequirements";
        ...
        return oMetaModel.requestObject(`/${sCollectionPath}/$Type`)
            ...
            .catch(function (oError) {
                const mFallbackProperties = {
                    "ProjectRequirements": [
                        { name: "reqId", path: "reqId", label: "Requirement ID", dataType: "Edm.String", sortable: true, filterable: true, groupable: true },
                        ...
                        { name: "experienceMin", path: "experienceMin", label: "Min Experience", dataType: "Edm.Decimal", sortable: true, filterable: true, groupable: true },
                        { name: "quantity", path: "quantity", label: "Quantity", dataType: "Edm.Int32", sortable: true, filterable: true, groupable: true }
                    ]
                };
    ...
    GenericTableDelegate.updateBindingInfo = function (oTable, oBindingInfo) {
        ...
        const sPath = oTable.getPayload()?.collectionPath || "ProjectRequirements";
